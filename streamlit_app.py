...
# 장르 목록 생성
genres = ["전체"] + sorted(list(set([m['genre'] for m in musicals_data])))
...
if st.session_state.selected_genre == "전체":
    ...
    genre_filtered_musicals = [m for m in musicals_data if m['genre'] == st.session_state.selected_genre]
